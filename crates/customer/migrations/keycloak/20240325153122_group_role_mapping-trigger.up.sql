...
CREATE OR REPLACE FUNCTION group_role_mapping_update() RETURNS TRIGGER AS $$
    DECLARE
    row RECORD;
    output TEXT;
    ...
    PERFORM pg_notify('group_role_mapping_update', output);
...
CREATE OR REPLACE TRIGGER trigger_group_role_mapping_update
  AFTER INSERT OR UPDATE OR DELETE
  ON group_role_mapping
  FOR EACH ROW
  EXECUTE PROCEDURE group_role_mapping_update();