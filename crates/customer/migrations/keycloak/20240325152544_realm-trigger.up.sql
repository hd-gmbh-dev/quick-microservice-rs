...
CREATE OR REPLACE FUNCTION realm_update() RETURNS TRIGGER AS $$
    DECLARE
    row RECORD;
    output TEXT;
    ...
    PERFORM pg_notify('realm_update', output);
...
CREATE OR REPLACE TRIGGER trigger_realm_update
  AFTER INSERT OR UPDATE OR DELETE
  ON realm
  FOR EACH ROW
  EXECUTE PROCEDURE realm_update();