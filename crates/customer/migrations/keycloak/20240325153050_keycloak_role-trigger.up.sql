...
CREATE OR REPLACE FUNCTION keycloak_role_update() RETURNS TRIGGER AS $$
    DECLARE
    row RECORD;
    output TEXT;
    ...
    PERFORM pg_notify('keycloak_role_update', output);
...
CREATE OR REPLACE TRIGGER trigger_keycloak_role_update
  AFTER INSERT OR UPDATE OR DELETE
  ON keycloak_role
  FOR EACH ROW
  EXECUTE PROCEDURE keycloak_role_update();