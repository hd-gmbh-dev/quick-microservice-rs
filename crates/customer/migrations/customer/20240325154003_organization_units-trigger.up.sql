...
CREATE OR REPLACE FUNCTION organization_units_update() RETURNS TRIGGER AS $$
    DECLARE
    row RECORD;
    output TEXT;
    ...
    PERFORM pg_notify('organization_units_update', output);
...
CREATE OR REPLACE TRIGGER trigger_organization_units_update
  AFTER INSERT OR UPDATE OR DELETE
  ON organization_units
  FOR EACH ROW
  EXECUTE PROCEDURE organization_units_update();