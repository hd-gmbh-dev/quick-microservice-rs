...
CREATE OR REPLACE FUNCTION organizations_update() RETURNS TRIGGER AS $$
    DECLARE
    row RECORD;
    output TEXT;
    ...
    PERFORM pg_notify('organizations_update', output);
...
CREATE OR REPLACE TRIGGER trigger_organizations_update
  AFTER INSERT OR UPDATE OR DELETE
  ON organizations
  FOR EACH ROW
  EXECUTE PROCEDURE organizations_update();